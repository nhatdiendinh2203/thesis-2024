			...
			<ul>
				...
				<li>
					...
					<ul class='submenu'>
						...
						<li>
							<center><a href="danhsachtin/{{$lt->id}}">{{$lt->tenloaitin}}</a></center>
						</li>
						@endif
						@endforeach
					</ul>
				...
				<li>
					...
					<ul class='submenu'>
						<li>
							<center><a href="">Tham khảo chung</a></center>
						</li>
						@can('quyensinhvien')
						<li>
							<center><a href="">Sinh viên</a></center>
						</li>
						@endcan
						@can('quyengiangvien')
						<li>
						...
						<li>
							<center><a href="">Giảng viên</a></center>
						</li>
						@endcan
					</ul>
				</li>
			...
			<div class="right">
				<div class="right-news">
					...
					<div class="right-information">
						...
						<div class="ArticleNewTitle" align="center">
							<center><b>{{$dulieuthongbao->tieude}}</b></center>
						</div>
						<hr>
					...
					<div class="right-news_border">
						<div class="marquee">
							...
							<div class="right-news__box">
								<a href="tintuc/{{$bvnbc->id}}"><img src="assets/user/images/hinhtintuc/{{$bvnbc->hinhdaidien}}" alt=""></a>
		...
		<div class="container">
			<div class="footer-left">
				<div class="title-footer">
					KHOA TIN HỌC - TRƯỜNG ĐẠI HỌC ĐHQG TPHCM
				</div>
				<ul>
					...
					<li>Bản quyền © thuộc về khoa Tin Học trường đại học ĐHQG TPHCM, thiết kế bởi Huỳnh Văn Thùy.</li>
				</ul>
			</div>
			<div class="footer-right">
				<iframe src="https://www.facebook.com/plugins/page.php?href=https://www.facebook.com/Khoa-Tin-Ho%CC%A3c-%C4%90HSP-Hu%C3%AA%CC%81-609379282849972/&width=500&height=300&small_header=false&adapt_container_width=true&hide_cover=false&show_facepile=true&appId" width="500" height="300" style="border:none;overflow:hidden" scrolling="no" frameborder="0" allowTransparency="true" allow="encrypted-media"></iframe>
			</div>
		</div>
	</footer> <!-- END FOOTER -->
</body>
