...
class tintucsTableSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        DB::table('tin_tucs')->insert(
            [
                [
                    'tieude' => "Hội thi “Tìm hiểu Chương trình Giáo dục phổ thông mới cấp Tiểu học”",
                    'mota' => "Chương trình Giáo dục phổ thông tổng thể (2017) và Chương trình giáo dục phổ thông các môn học (Ban hành kèm theo Thông tư số 32/2018/TT-BGDĐT ngày 26 tháng 12 năm 2018 của Bộ trưởng Bộ GD&ĐT) đã đặt ra những cơ hội và thách thức cho hoạt động đào tạo ở các trường đại học sư phạm, các trường phổ thông trong cả nước. Trước nhiệm vụ phát triển năng lực sư phạm của giáo viên trong bối cảnh mới, Trường Đại học Sư phạm, Đại học Huế đã khuyến khích các đơn vị tổ chức các hoạt động giúp sinh viên tìm hiểu về Chương trình giáo dục phổ thông mới.",
                    'hinhdaidien' => "1556362611TinTuc1.jpg",
                    'noidung' => '  <div>
                                <div id="PAGE1">
                                <div>
                                <p>&nbsp;</p>
                    ...
                    'id_loaitin' => 5,
                    'id_user' => 1,
                    'created_at' => "2019-04-27 17:46:08",
                    'updated_at' => "2019-04-27 17:56:51",
                ],
                [
                    'tieude' => "Thông báo kết quả thi Tuyển sinh cao học lần 1 năm 2019",
                    'mota' => "Thông báo kết quả thi Tuyển sinh cao học lần 1 năm 2019",
                    'hinhdaidien' => "1556362529avatar.jpg",
                    'noidung' => '<div><strong>Th&ocirc;ng b&aacute;o kết quả thi Tuyển sinh cao học lần 1 năm 2019</strong></div>
                        <div id="PAGE1">
                        <div>
                    ...
                    'id_loaitin' => 12,
                    'id_user' => 1,
                    'created_at' => "2019-04-27 17:55:29",
                    'updated_at' => "2019-04-27 17:55:46",
                ],
                [
                    'tieude' => "THÔNG BÁO Chấm phúc khảo cho thí sinh dự thi Kỳ thi tuyển sinh Cao học lần 1 năm 2019 tại Đại học Huế",
                    'mota' => "THÔNG BÁO Chấm phúc khảo cho thí sinh dự thi Kỳ thi tuyển sinh Cao học lần 1 năm 2019 tại Đại học Huế",
                    'hinhdaidien' => "1556362721avatar.jpg",
                    'noidung' => '<div style="text-align: center;"><strong>TH&Ocirc;NG B&Aacute;O Chấm ph&uacute;c khảo cho th&iacute; sinh dự thi Kỳ thi tuyển sinh Cao học lần 1 năm 2019 tại Đại học Huế</strong></div>
                        <div id="PAGE1">
                        <div>
                    ...
                    'id_loaitin' => 12,
                    'id_user' => 1,
                    'created_at' => "2019-04-27 17:58:41",
                    'updated_at' => "2019-04-27 17:58:41",
                ],
                [
                    'tieude' => "Thông báo Bảo vệ luận án tiến sĩ cấp cơ sở (Huỳnh Thị Minh Thành)",
                    'mota' => "Thực hiện Quyết định số 229/QĐ-ĐHH ngày 05/03/2019 của Giám đốc Đại học Huế, Trường Đại học Sư phạm tổ chức đánh giá luận án Tiến sĩ cấp Đại học Huế về đề tài: Nghiên cứu đặc điểm sinh học của rệp sáp bột hồng hại sắn (Phenacoccus manihoti Matile - Ferrero, 1977) và khả năng khống chế rệp của ong ký sinh (Anagyrus lopezi De Santis, 1964) 
                        Chuyên ngành: Động vật học",
                    'hinhdaidien' => "1556362865avatar.jpg",
                    'noidung' => '<div style="text-align: center;"><strong>Th&ocirc;ng b&aacute;o Bảo vệ luận &aacute;n tiến sĩ cấp Đại học Huế (Ho&agrave;ng Hữu T&igrave;nh)</strong></div>
                    <div id="PAGE1">
                    <div>
                    ...
                    'id_loaitin' => 12,
                    'id_user' => 1,
                    'created_at' => "2019-04-27 18:00:03",
                    'updated_at' => "2019-04-27 18:00:03",
                ],
                [
                    'tieude' => "Thông báo Bảo vệ luận án tiến sĩ cấp Đại học Huế (Hoàng Hữu Tình)",
                    'mota' => "Thực hiện Quyết định số 229/QĐ-ĐHH ngày 05/03/2019 của Giám đốc Đại học Huế, Trường Đại học Sư phạm tổ chức đánh giá luận án Tiến sĩ cấp Đại học Huế về đề tài: Nghiên cứu đặc điểm sinh học của rệp sáp bột hồng hại sắn (Phenacoccus manihoti Matile - Ferrero, 1977) và khả năng khống chế rệp của ong ký sinh (Anagyrus lopezi De Santis, 1964) 
                        Chuyên ngành: Động vật học",
                    'hinhdaidien' => "1556362865avatar.jpg",
                    'noidung' => '<div style="text-align: center;"><strong>Th&ocirc;ng b&aacute;o Bảo vệ luận &aacute;n tiến sĩ cấp Đại học Huế (Ho&agrave;ng Hữu T&igrave;nh)</strong></div>
                    ...
                    'id_loaitin' => 12,
                    'id_user' => 1,
                    'created_at' => "2019-04-27 18:01:05",
                    'updated_at' => "2019-04-27 18:01:05",
                ],
                [
                    'tieude' => "Thông tin luận án tiến sĩ (Trần Nam Sinh)",
                    'mota' => "1. NCS Trần Nam Sinh - CN: Đại số Và lý thuyết số

                                Mã số: 62460104  Bảo vệ  lúc ..... giờ....., ngày ..... tháng ...... năm 20….

                                - Cơ sở đào tạo: Trường Đại học Sư phạm -  ĐHH",
                    'hinhdaidien' => "1556362952avatar.jpg",
                    'noidung' => '<div><strong>Th&ocirc;ng tin luận &aacute;n tiến sĩ (Trần Nam Sinh)</strong></div>
                    <div id="PAGE1">
                    <div>
                    ...
                    'id_loaitin' => 12,
                    'id_user' => 1,
                    'created_at' => "2019-04-27 18:02:32",
                    'updated_at' => "2019-04-27 18:02:32",
                ],
                [
                    'tieude' => "Đội tuyển Olympic Vật lý xuất sắc đạt 2 Giải Nhất và 5 Giải Ba Cuộc thi Olympic Vật lý sinh viên toàn quốc",
                    'mota' => "Đội tuyển Olympic Vật lý Trường Đại học ĐHQG TPHCM xuất sắc đạt Giải Nhì toàn đoàn tại Cuộc thi Olympic Vật lý sinh viên toàn quốc với  02 Giải Nhất (Phần thi thí nghiệm Vật lý) và 05 Giải Ba (Phần thi Giải bài tập vật lý, Trắc nghiệm vật lý).",
                    'hinhdaidien' => "1556363043tintuc2.jpg",
                    'noidung' => '<div><strong>Đội tuyển Olympic Vật l&yacute; xuất sắc đạt 2 Giải Nhất v&agrave; 5 Giải Ba Cuộc thi Olympic Vật l&yacute; sinh vi&ecirc;n to&agrave;n quốc</strong></div>
                    <div id="PAGE1">
                    <div>
                    ...
                    'id_loaitin' => 6,
                    'id_user' => 1,
                    'created_at' => "2019-04-27 18:04:03",
                    'updated_at' => "2019-04-27 18:04:03",
                ],
                [
                    'tieude' => "203 tân Tiến sĩ, Thạc sĩ nhận bằng tốt nghiệp",
                    'mota' => "Sáng 29/3/2019, Trường Đại học Sư phạm, Đại học Huế long trọng tổ chức Lễ tốt nghiệp và trao bằng Tiến sĩ, Thạc sĩ năm 2019.",
                    'hinhdaidien' => "1556363186tintuc3.jpg",
                    'noidung' => '<div><strong>203 t&acirc;n Tiến sĩ, Thạc sĩ nhận bằng tốt nghiệp</strong></div>
                    <div id="PAGE1">
                    <div>
                    ...
                    'id_loaitin' => 10,
                    'id_user' => 1,
                    'created_at' => "2019-04-27 18:06:26",
                    'updated_at' => "2019-04-27 18:06:26",
                ],
                [
                    'tieude' => "Thông báo Tuyển sinh Nghiên cứu sinh năm 2019 của Đại học Huế",
                    'mota' => "Đại học Huế thông báo tuyển nghiên cứu sinh năm 2019 cho 46 chuyên ngành vào các trường đại học thành viên.",
                    'hinhdaidien' => "1556363474avatar.jpg",
                    'noidung' => '<div style="text-align: center;"><strong>Th&ocirc;ng b&aacute;o Tuyển sinh Nghi&ecirc;n cứu sinh năm 2019 của Đại học Huế</strong></div>
                    <div id="PAGE1">
                    <div>
                    <div>
                    ...
                    'id_loaitin' => 2,
                    'id_user' => 1,
                    'created_at' => "2019-04-27 18:11:14",
                    'updated_at' => "2019-04-27 18:11:14",
                ],
                [
                    'tieude' => "“Làm sạch biển và xây dựng môi trường xanh - sạch - sáng”",
                    'mota' => "Ngày 28/4, Trường Đại học Sư phạm, Đại học Huế tổ chức ra quân thực hiện chiến dịch:“Làm sạch biển và xây dựng môi trường xanh - sạch - sáng” nhằm hưởng ứng Ngày Môi trường thế giới (5/6/2019).",
                    'hinhdaidien' => "1556997044hinh1.jpg",
                    'noidung' => '<p>\</p>
                ...
                [
                    ...
                    'id_loaitin' => 5,
                    'id_user' => 1,
                    'created_at' => "2019-05-05 02:12:30",
                    'updated_at' => "2019-05-05 02:12:30",
                ],
